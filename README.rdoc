...
are divided-up into *testcases*, *contexts*, *concerns*, *tests*.
...
directory where it will be loaded up automatically ready for, yep, use.

BTW, if you are a Cuke, you can use capitalized KO's method names.
